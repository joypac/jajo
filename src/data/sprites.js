...
/* casa alentejana, caiada de branco */
PROPS.casaAlentejo = paint(48, 48, (px) => {
  px(6, 6, 36, 4, '#8f3844');
  px(3, 10, 42, 4, '#b8515e');
  px(0, 14, 48, 5, '#a8434f');
  px(6, 8, 34, 2, '#c96f78');
  px(4, 19, 40, 25, '#f6f4ee');
  px(4, 19, 40, 2, '#d8d4c8');
  px(4, 38, 40, 6, '#3f6fa8');
  px(4, 44, 40, 3, '#8a8a9c');
  px(2, 19, 2, 25, '#d0ccc0'); px(44, 19, 2, 25, '#d0ccc0');
  px(20, 26, 10, 18, '#5a7f4a');
  px(20, 26, 10, 2, '#3f5c33');
  px(21, 28, 8, 14, '#6b9459');
  px(27, 34, 2, 2, '#f2c14e');
  px(9, 24, 8, 8, '#3f6fa8'); px(10, 25, 6, 6, '#cfe6f2');
  px(33, 24, 8, 8, '#3f6fa8'); px(34, 25, 6, 6, '#cfe6f2');
  px(12, 24, 1, 8, '#3f6fa8'); px(37, 24, 1, 8, '#3f6fa8');
  px(38, 0, 4, 8, '#e8e4d8'); px(37, 0, 6, 2, '#d0ccc0');
});
